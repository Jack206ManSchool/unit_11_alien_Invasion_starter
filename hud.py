...
class HUD:
    ...
    def _update_max_score(self):
        ...
        self.max_score_image = self.font.render(max_score_str, False, 
            self.settings.text_color, None)
    ...
    def update_level(self):
        ...
        self.level_image = self.font.render(level_str, False, 
            self.settings.text_color, None)
        self.level_rect = self.level_image.get_rect()
        self.level_rect.left = self.padding
        self.level_rect.top = self.level_rect.bottom + (self.padding * 3)
